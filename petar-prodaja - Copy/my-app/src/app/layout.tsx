...
export default function RootLayout({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 6. Ticker animacija - ide u levo beskonačno
        ...
        <div className=" relative bg-black text-gray-900 flex flex-col min-h-screen ">
          ...
          >
            ...
            <div className="overflow-hidden bg-amber-400 py-2 border-y border-black/10 whitespace-nowrap flex">
              <div ref={tickerTopRef} className="flex gap-10 items-center">
                {[...Array(10)].map((_, i) => (
                  <h3
                    key={`top-orig-${i}`}
                    className="text-black font-black uppercase italic text-sm md:text-xl inline-block shrink-0"
                  >
            ...
            <div className="overflow-hidden bg-amber-400 py-2 border-y border-black/10 whitespace-nowrap flex">
              <div ref={tickerBottomRef} className="flex gap-10 items-center">
                {[...Array(10)].map((_, i) => (
                  <h3
                    key={`bot-orig-${i}`}
                    className="text-black font-black uppercase italic text-sm md:text-xl inline-block shrink-0"
